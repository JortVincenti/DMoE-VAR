...
from methods.dynamic_sparsification.count_flops import train as count_flops
...
def main():
    ...
    path_file_router = [
        'DMoE-VAR/shared/results/effbench_runs/relu_var_d20_router/final.pth'
    ]
    ...
    for base_on_exp_name in base_split_exp_names:
        for exp_id in exp_ids:
            for i in range(len(final_path_save)):
                ...
                dsti_routing_args.path_file_router = path_file_router[i]
                ...
                dsti_routing_args.expert_index_switch = 12
                count_flops(dsti_routing_args)
